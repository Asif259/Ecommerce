          ...
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center space-x-3 group">
              <motion.div
                ...
                className="w-10 h-10 bg-gradient-to-br from-[#FAF8F5] to-[#D4C5B9] rounded-xl flex items-center justify-center shadow-lg"
              >
                <Sparkles className="text-[#7F6244] h-5 w-5" />
              </motion.div>
